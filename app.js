...
const LOAD_STEPS=[
  {at:0,text:'Analyzing your profile…',sub:'Matching against 479 supplements'},
...
function switchTab(tab){
  const views={supplements:document.getElementById('supplements-view'),articles:document.getElementById('articles-view'),about:document.getElementById('about-view')};
  const tabs={supplements:document.getElementById('tab-supplements'),profile:document.getElementById('tab-profile'),articles:document.getElementById('tab-articles'),about:document.getElementById('tab-about')};
  ...
  if(tab==='articles'&&typeof showArticleList==='function')showArticleList();
